...
class ControllerExtensionFeedTrsSitemap extends Controller {
  ...
  public function index() {
    ...
    if (!$this->config->get('trs_sitemap_status') ||
        !(isset($this->request->get['key']) && $this->request->get['key'] == $this->config->get('trs_sitemap_key'))) {
      return false;
    }

    // If generation completed
    if ($this->config->get('trs_sitemap_products_sitemap_completed') &&
        $this->config->get('trs_sitemap_categories_sitemap_completed') &&
        $this->config->get('trs_sitemap_manufacturers_sitemap_completed') &&
        $this->config->get('trs_sitemap_informations_sitemap_completed')) {
        $this->_updateSitemapRoot();
    }

    // Calculate duration
    $duration_hours   = $this->config->get('trs_sitemap_duration');
    ...
    if ($products_count) {
      $this->_products_database_offset = $this->config->get('trs_sitemap_products_database_offset') ? $this->config->get('trs_sitemap_products_database_offset') : 0;
      $this->_products_sitemap_offset  = $this->config->get('trs_sitemap_products_sitemap_offset')  ? $this->config->get('trs_sitemap_products_sitemap_offset')  : 0;
      $this->_products_sitemap_index   = $this->config->get('trs_sitemap_products_sitemap_index')   ? $this->config->get('trs_sitemap_products_sitemap_index')   : 1;
    ...
    if ($manufacturers_count) {
      $this->_manufacturers_database_offset = $this->config->get('trs_sitemap_manufacturers_database_offset') ? $this->config->get('trs_sitemap_manufacturers_database_offset') : 0;
      $this->_manufacturers_sitemap_offset  = $this->config->get('trs_sitemap_manufacturers_sitemap_offset')  ? $this->config->get('trs_sitemap_manufacturers_sitemap_offset')  : 0;
      $this->_manufacturers_sitemap_index   = $this->config->get('trs_sitemap_manufacturers_sitemap_index')   ? $this->config->get('trs_sitemap_manufacturers_sitemap_index')   : 1;
    ...
    if ($informations_count) {
      ...
      $this->_informations_database_offset = $this->config->get('trs_sitemap_informations_database_offset') ? $this->config->get('trs_sitemap_informations_database_offset') : 0;
      $this->_informations_sitemap_offset  = $this->config->get('trs_sitemap_informations_sitemap_offset')  ? $this->config->get('trs_sitemap_informations_sitemap_offset')  : 0;
      $this->_informations_sitemap_index   = $this->config->get('trs_sitemap_informations_sitemap_index')   ? $this->config->get('trs_sitemap_informations_sitemap_index')   : 1;
    ...
    if ($categories_count) {
      ...
      $this->_categories_database_offset = $this->config->get('trs_sitemap_categories_database_offset') ? $this->config->get('trs_sitemap_categories_database_offset') : 0;
      $this->_categories_sitemap_offset  = $this->config->get('trs_sitemap_categories_sitemap_offset')  ? $this->config->get('trs_sitemap_categories_sitemap_offset')  : 0;
      $this->_categories_sitemap_index   = $this->config->get('trs_sitemap_categories_sitemap_index')   ? $this->config->get('trs_sitemap_categories_sitemap_index')   : 1;
  ...
  private function _updateSitemapRoot() {
    ...
    if ($body) {
      ...
      $this->model_extension_feed_trs_sitemap->editSetting('trs_sitemap',
                                                           'trs_sitemap_products_sitemap_completed',
                                                           0,
                                                           $this->config->get('store_id'));
      $this->model_extension_feed_trs_sitemap->editSetting('trs_sitemap',
                                                           'trs_sitemap_categories_sitemap_completed',
                                                           0,
                                                           $this->config->get('store_id'));
      $this->model_extension_feed_trs_sitemap->editSetting('trs_sitemap',
                                                           'trs_sitemap_manufacturers_sitemap_completed',
                                                           0,
                                                           $this->config->get('store_id'));
      $this->model_extension_feed_trs_sitemap->editSetting('trs_sitemap',
                                                           'trs_sitemap_informations_sitemap_completed',
                                                           0,
                                                           $this->config->get('store_id'));
    }
  }
  ...
  private function _writeSitemapIndex($type, $data, $total, &$database_offset, &$sitemap_offset, &$sitemap_index) {
    ...
    if ($this->config->get(sprintf('trs_sitemap_%s_sitemap_completed', $type))) {
      return false;
    }
    ...
    if ($sitemap_offset >= $this->config->get('trs_sitemap_limit')) {
    ...
    // Update DB
    $this->model_extension_feed_trs_sitemap->editSetting('trs_sitemap',
                                                          sprintf('trs_sitemap_%s_database_offset', $type),
                                                          $database_offset,
                                                          $this->config->get('store_id'));

    $this->model_extension_feed_trs_sitemap->editSetting('trs_sitemap',
                                                          sprintf('trs_sitemap_%s_sitemap_offset', $type),
                                                          $sitemap_offset,
                                                          $this->config->get('store_id'));

    $this->model_extension_feed_trs_sitemap->editSetting('trs_sitemap',
                                                          sprintf('trs_sitemap_%s_sitemap_index', $type),
                                                          $sitemap_index,
                                                          $this->config->get('store_id'));

    $this->model_extension_feed_trs_sitemap->editSetting('trs_sitemap',
                                                          sprintf('trs_sitemap_%s_sitemap_completed', $type),
                                                          $completed,
                                                          $this->config->get('store_id'));
  }
}
